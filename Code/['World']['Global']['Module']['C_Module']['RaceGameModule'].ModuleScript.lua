...
function RaceGame:NodeDef()
	---如果玩家检测体不够大再扩一下
	print(Config.RacePoint[this.nowKey])
	this.checkPoint = world:CreateInstance("CheckPoint","CheckPoint",localPlayer.Local.Independent,Config.RacePoint[this.nowKey][1].Pos)
