    ...
    if this.timer >= this.timeSpeed then
        ...
        if Config.TimeSkySetting[this.clock] then
            if this.clock == 10 then
                NetUtil.Broadcast('InsertInfoEvent', Config.GuiText.InfoGui_1.Txt, 10,false)
            elseif this.clock == 18 then
                NetUtil.Broadcast('InsertInfoEvent', Config.GuiText.InfoGui_2.Txt, 10,false)
            elseif this.clock == 20 then
                NetUtil.Broadcast('InsertInfoEvent', Config.GuiText.InfoGui_3.Txt, 10,false)
            end
        end
